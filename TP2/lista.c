...
int lista_borrar_de_posicion(lista_t* lista, size_t posicion){
	...
	//if(obtener_puntero_a_nodo(lista, posicion) == lista->nodo_fin)
		//return lista_borrar(lista);
	...
	nodo_t* nodo_a_borrar = obtener_puntero_a_nodo(lista, posicion);
...
lista_iterador_t* lista_iterador_crear(lista_t* lista){
	...
	iter->lista = lista;
	iter->corriente = NULL;
	iter->elementos_restantes = lista_elementos(lista);
...
bool lista_iterador_tiene_siguiente(lista_iterador_t* iterador){
	...
	return (iterador->elementos_restantes > 0);
...
void* lista_iterador_siguiente(lista_iterador_t* iterador){
	...
	if(!iterador->corriente && iterador->lista->nodo_inicio){
		iterador->elementos_restantes--;
